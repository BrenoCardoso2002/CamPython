...
class redimensionaImagem():
    ...
    def saveImage(self):
        ...
        imagemCarregada = self.getImagemRedimensionada()
...
if redimensionaImagem.verificaImage():
    ...
    if redimensionaImagem.verificaCarregamento():
        ...
        # redimensionaImagem.setNovoNomeImage()
        redimensionaImagem.setNovoCaminhoCompleto()
        redimensionaImagem.saveImage()
        redimensionaImagem.verificaNovaImagem()
