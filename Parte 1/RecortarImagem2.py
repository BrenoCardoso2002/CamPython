...
class recortaImagem():
    ...
    def saveImage(self):
        ...
        imagemCarregada = self.getImagemCortada()
...
if recortaImagem.verificaImage():
    ...
    if recortaImagem.verificaCarregamento():
        ...
        # recortaImagem.setNovoNomeImage()
        recortaImagem.setNovoCaminhoCompleto()
        recortaImagem.saveImage()
        recortaImagem.verificaNovaImagem()
